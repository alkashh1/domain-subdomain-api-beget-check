...
ZABBIX_SERVER="127.0.0.1:10050"  # Замените на IP или имя вашего Zabbix сервера
HOSTNAME="vpn-server6"  # Имя хоста в Zabbix
ITEM_KEY="domain.subdomain.fromfile"  # Уникальный ключ элемента данных
FILE_PATH="/home/zabbix/scripts/DomainTree/domain_tree.txt"  # Путь к вашему файлу
