...
url_subdomain = f'https://api.beget.com/api/domain/getSubdomainList?login={login}&passwd={password}&output_format=json'
...
if response.status_code == 200:
    ...
    with open('subdomain.json', 'w') as file:
        json.dump(data, file, indent=4, ensure_ascii=False)

    print("Данные успешно сохранены в файл subdomain.json")
else:
